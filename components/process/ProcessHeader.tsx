import type { ProcessContent } from "./process-content";
...
/**
 * Cabecera editorial de "Cómo Trabajo".
 * Misma estética que ExperienceHeader: eyebrow + display título full-width
 * e intro asimétrica con borde superior estructural.
 */
export function ProcessHeader({ content }: ProcessHeaderProps) {
